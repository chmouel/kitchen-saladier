...
from saladier.openstack.common import fileutils
from saladier.openstack.common.gettextutils import _, _LE, _LI
...
util_opts = [
    ...
    cfg.StrOpt('lock_path',
               default=os.environ.get("SALADIER_LOCK_PATH"),
...
def main(argv):
    ...
    os.environ["SALADIER_LOCK_PATH"] = lock_dir
    try:
